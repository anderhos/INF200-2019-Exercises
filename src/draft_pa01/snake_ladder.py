...
# Source https://www.pythoncircle.com/post/676/text-based-snake-and-ladder-game-in-python/
# Github https://github.com/anuragrana/Python-Scripts/blob/master/snake_ladder.py
